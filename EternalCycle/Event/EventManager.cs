...
namespace EternalCycleServer
{
    ...
    public class EventManager
    {
        ...
        public static void InitLoadGiftCodeEvent(LoadModContext context)
        {
            InitRagfairEvent(DataLoadEvent.LoadGiftCodeEvent, context);
        }

        public static void InitLoadAlterBotEvent(LoadModContext context)
        {
        ...
        public static void InitLoadDialogueEvent(LoadModContext context)
        {
